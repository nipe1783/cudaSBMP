...
public:
    ...
    thrust::device_vector<int> d_scanIdx_;  // stores scan of G.
    // ex: G = [0, 1, 0, 1, 1, 0, 1] -> scanIdx = [0,0,1,1,2,3,3]. Used to find active samples in G.
...
__global__ void propagateG(int sizeG, int* activeGIdx, bool* G, bool* GNew, float* treeSamples, float* unexploredSamples, int* uParentIdx,
                           ...
                           float* R1Scores, float* obstacles, int obstacleCount, float width, float height);
...
propagateGV2(int sizeG, int* activeGIdx, bool* G, bool* GNew, float* treeSamples, float* unexploredSamples, int* uParentIdx, int* R1Valid,
             ...
             int obstacleCount, int iterations, float width, float height);

__global__ void updateR1(float* R1Score, int* R1Avail, int* R2Avail, int* R1Valid, int* R1Invalid, int* R1Sel, int n, float epsilon,
